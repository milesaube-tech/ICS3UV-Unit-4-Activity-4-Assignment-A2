...
if (userOperation == "a"){
  ...
  let userValue1AsString: string;
  let userValue2AsString: string;
  userValue1AsString = prompt("Please enter your first number") || "0";
  userValue2AsString = prompt("Please enter your second number") || "0";
...
if (userOperation == "e") {
  let userValue1AsNumber: number;
  let userValue1AsString: string;
  userValue1AsString = prompt("Please enter the integer to make absolute") || "0";
  userValue1AsNumber = parseInt(userValue1AsString);
...
if (userOperation == "f") {
  let userValue1AsNumber: number;
  let userValue1AsString: string;
  userValue1AsString = prompt("Please enter the number you want to round") || "0";
...
if (userOperation == "g") {
  ...
  let userValue1AsString: string;
  let userValue2AsString: string;
  userValue1AsString = prompt("Please enter your base number") || "0";
  userValue2AsString = prompt("Please enter your exponent") || "0";
  userValue1AsNumber = parseInt(userValue1AsString);
  userValue2AsNumber = parseInt(userValue2AsString);
